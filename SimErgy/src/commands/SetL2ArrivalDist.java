...
/**
 * 
 * This command sets the arrival time probability of patients with severity L2 to the ED  the given name inputed by the user, within the CLUI system; 
 *
 */
public class SetL2ArrivalDist extends Command{

	private String edName;
	private ProbabilityDensity probL2;

	public SetL2ArrivalDist(SimErgyCLUI clui,String[] args) throws SyntaxErrorException, ArgumentsMismatchException {
		super(clui,args);
