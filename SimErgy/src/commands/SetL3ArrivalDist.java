...
/**
 * 
 * This command sets the arrival time probability of patients with severity L3 to the ED  the given name inputed by the user, within the CLUI system; 
 *
 */

public class SetL3ArrivalDist extends Command{
	
	private String edName;
	private ProbabilityDensity probL3;

	public SetL3ArrivalDist(SimErgyCLUI clui,String[] args) throws SyntaxErrorException, ArgumentsMismatchException {
		super(clui,args);
