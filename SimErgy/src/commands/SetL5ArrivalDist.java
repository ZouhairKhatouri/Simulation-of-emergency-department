...
/**
 * 
 * This command sets the arrival time probability of patients with severity L5 to the ED  the given name inputed by the user, within the CLUI system; 
 *
 */

public class SetL5ArrivalDist extends Command{
	
	private String edName;
	private ProbabilityDensity probL5;

	public SetL5ArrivalDist(SimErgyCLUI clui,String[] args) throws SyntaxErrorException, ArgumentsMismatchException {
		super(clui,args);
